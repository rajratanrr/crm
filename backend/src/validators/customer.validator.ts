...
export const createCustomerSchema = z.object({
  ...
  shootType: z.string().max(150).optional().nullable(),
  productType: z.string().max(250).optional().nullable(),
  projectAmount: z.union([z.number(), z.string()]).optional().nullable(),
  studioAmount: z.union([z.number(), z.string()]).optional().nullable(),
  shootDate: z.string().optional().nullable(),
  clothInDate: z.string().optional().nullable(),
  clothOutDate: z.string().optional().nullable(),
